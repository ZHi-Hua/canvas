class Draw {
    ...
    drawFont (x, y) {
        let temp = "";
        let row = [];
        let fontSizeObj = document.getElementById('fontSize');
        let fontSize = fontSizeObj.options[fontSizeObj.selectedIndex].value;
        let fontObj = document.getElementById('fontFamily');
        let font = fontSize + " " + fontObj.options[fontObj.selectedIndex].value;
        ...
        if (this.textContent.indexOf("\n") >= 0) {
            ...
            let chr = this.textContent.split("");
    ...
    handleOperations () {
        return {
            ...
            font: () => {
                ...
                if(!this.ifFontPop){
                    // 弹出框
                    document.getElementById('fontDetail').style.display = "block";
                }else{
                    document.getElementById('fontDetail').style.display = "none";
                }
